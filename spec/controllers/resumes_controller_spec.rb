...
RSpec.describe ResumesController, type: :controller do
  ...
  describe "GET #show" do
    it "assigns the requested resume as @resume" do
      resume = Resume.create! valid_attributes
      get :show, params: {id: resume.to_param}, session: valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested resume as @resume" do
      resume = Resume.create! valid_attributes
      get :edit, params: {id: resume.to_param}, session: valid_session
      expect(assigns(:resume)).to eq(resume)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Resume" do
        expect {
          post :create, params: {resume: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved resume as @resume" do
        post :create, params: {resume: invalid_attributes}, session: valid_session
        expect(assigns(:resume)).to be_a_new(Resume)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested resume" do
        resume = Resume.create! valid_attributes
        put :update, params: {id: resume.to_param, resume: new_attributes}, session: valid_session
        resume.reload
      ...
      it "assigns the requested resume as @resume" do
        resume = Resume.create! valid_attributes
        put :update, params: {id: resume.to_param, resume: valid_attributes}, session: valid_session
        expect(assigns(:resume)).to eq(resume)
      end
    ...
    context "with invalid params" do
      it "assigns the resume as @resume" do
        resume = Resume.create! valid_attributes
        put :update, params: {id: resume.to_param, resume: invalid_attributes}, session: valid_session
        expect(assigns(:resume)).to eq(resume)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested resume" do
      resume = Resume.create! valid_attributes
      expect {
        delete :destroy, params: {id: resume.to_param}, session: valid_session
      }.to change(Resume, :count).by(-1)
    end
